...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView mtodaytotal,mtotal,mactive,mtodayaactive,mrecovered,mtodayrecovered,mdeaths,mtodaydeaths;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtodayaactive=findViewById(R.id.todayactive);
    ...
    private void updateGraph(int active, int total, int recovered, int deaths) {
        ...
        mpieChart.addPieSlice(new PieModel("Confirm",active,Color.parseColor("#FF4CAF50")));
        mpieChart.addPieSlice(new PieModel("Confirm",recovered,Color.parseColor("#38ACCD")));
        mpieChart.addPieSlice(new PieModel("Confirm",deaths,Color.parseColor("#F55c47")));
